...
const mockUseWebRTC = vi.fn((_sessionId: string | null, enabled: boolean): {
...
describe('VideoPanel', () => {
  ...
  it('zeigt video Element', () => {
    const { container } = render(<VideoPanel sessionId={null} enabled={false} />)
